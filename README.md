...
### Ссылки на выпуск в репозитории или запросы на внесения изменений

Любой номер, относящийся к проблеме или запросу на извлечение, будет автоматически преобразован в ссылку.
Например, 
