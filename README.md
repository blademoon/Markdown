...
### Ссылка на выпуск в репозитории или запросы на внесения изменений

Любой номер, относящийся к проблеме (Issue) или запросу на извлечение (Pull Request) или релизу, будет автоматически преобразован в ссылку.
Например, 
	...
	9e4a70633529cb7cdc57a5818c22813bd8794522
